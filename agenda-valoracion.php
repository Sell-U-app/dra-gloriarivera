...
<title>Agenda tu valoración con la Dra. Gloria Rivera | Invisalign® Bogotá</title>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    "@type": "Dentist",
    "name": "Dra. Gloria Rivera — Ortodoncia invisible",
...
.vsl-h1{font-family:var(--font-display); font-size:clamp(2rem, 2.4vw + 1rem, 3.25rem); line-height:1.08; letter-spacing:-0.015em; margin:0 0 24px; color:var(--carbon); text-wrap:balance;}
.vsl-h1 .accent{color:var(--dorado); font-style:italic;}
.vsl-subhead{font-size:18px; color:var(--gr-ink-70); margin:0; font-style:italic;}

.vsl-video-block{display:flex; flex-direction:column; gap:18px; width:100%; max-width:880px;}
.vsl-step-label{display:flex; align-items:center; justify-content:center; gap:8px; font-size:11px; letter-spacing:.22em; text-transform:uppercase; color:var(--piedra); font-weight:500;}
.vsl-step-num{color:var(--dorado);}
.vsl-step-sep{color:var(--hairline-strong);}
.vsl-player{position:relative; aspect-ratio:16/9; background:var(--gr-cream-deep); border-radius:8px; overflow:hidden; cursor:pointer; box-shadow:0 24px 60px -24px rgba(17,17,17,.25); border:1px solid var(--hairline-gold);
  background-image:
  ...
  <section id="inicio" class="vsl-section">
    <div class="vsl-inner">
      ...
      <div class="vsl-video-block">
        ...
        <div class="vsl-player" id="vsl-player" role="region" aria-label="Reproductor de video">
          <!-- Vidalytics embed -->
          <div id="vidalytics_embed_5V2KZIdMVJ8QzYhj" style="width:100%; position:relative; padding-top:56.25%;"></div>
        ...
        <button class="vsl-cta" data-scroll="#agendar">
...
// Calendar skeleton: ocultar al cargar el iframe de LeadConnector
(function(){
  ...
  if(iframe){
    ...
    // Fallback: ocultar después de 4s pase lo que pase.
    setTimeout(hide, 4000);
  }

  // Tracking GA4 / dataLayer de eventos del booking (LeadConnector usa postMessage)
